...
public class BusinessInfoServiceImpl implements BusinessInfoService {
    ...
    @Override
    public String uploadLogo(List<MultipartFile> multipartFile, Long userId, Long businessId) throws Exception {
        ...
        Optional<BusinessInfoEntity> businessInfoEntityOptional = businessInfoRepository.findByIdAndUserId(businessId, userId);
